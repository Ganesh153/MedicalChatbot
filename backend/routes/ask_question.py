...
async def ask_question(question:str=Form(...)):
    try:
        ...
        for match in res["matches"]:
            match_metadata = (match.get("metadata") or {}).copy()
            match_metadata["score"] = match.get("score")
            docs.append(
                Document(
                    page_content=match_metadata.get("text", ""),
        ...
        result = query_chain(chain, question, docs)
